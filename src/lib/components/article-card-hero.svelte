<script lang="ts">
  ...
  import Root from './ui/article-root.svelte';
  import Title from './ui/article-title.svelte';
  import Summary from './ui/article-summary.svelte';
  import ReadingTime from './ui/article-reading-time.svelte';
  import { User } from './ui';
  import { cn } from '../utils/cn';
  import { getContext } from 'svelte';
  import { ARTICLE_CONTEXT_KEY, type ArticleContext } from './ui/article.context.js';
  import { createTimeAgo } from '../utils';
