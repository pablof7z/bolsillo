<script lang="ts">
	...
	import { createBookmarkedRelayList } from './builders/bookmarks.svelte.js';
	import { getContext } from 'svelte';
	import { RELAY_CONTEXT_KEY, type RelayContext } from './ui/relay.context.js';
	import Root from './ui/relay-root.svelte';
	import Icon from './ui/relay-icon.svelte';
	import Name from './ui/relay-name.svelte';
	import Url from './ui/relay-url.svelte';
	import Description from './ui/relay-description.svelte';
	import BookmarkButton from './ui/relay-bookmark-button.svelte';
