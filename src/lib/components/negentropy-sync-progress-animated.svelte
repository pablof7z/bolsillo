<script lang="ts">
	import { NegentrogySync } from './ui';
	import { createNegentropySync } from './builders/index.js';
	import { getContext } from 'svelte';
	import { NEGENTROPY_SYNC_CONTEXT_KEY, type NegentropySyncContext } from './ui/negentropy-sync.context.js';
